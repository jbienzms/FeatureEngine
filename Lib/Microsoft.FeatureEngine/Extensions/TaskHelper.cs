...
namespace Microsoft.FeatureEngine
{
    ...
    static public class TaskHelper
    {
        ...
        /// </param>
        static private void DisplayError(Exception ex, TaskRunOptions options)
        {
            // Show failures?
        ...
        /// </returns>
        static public async Task RunWithErrorHandlingAsync(Func<Task> taskFunction, TaskRunOptions options = null)
        {
            // Validate
            ...
            {
                DisplayError(ex, options);
            }
        }

        /// <summary>
        /// Executes an <see cref="Action"/> asynchronously and handles any errors that occur.
        /// </summary>
        /// <param name="action">
        ...
        /// </returns>
        static public async Task RunWithErrorHandlingAsync(Action action, TaskRunOptions options = null)
        {
            // Validate
        ...
        /// <summary>
        /// Executes an <see cref="Action"/> synchronously and handles any errors that occur.
        /// </summary>
        /// <param name="action">
        /// The <see cref="Action"/> to execute.
        /// </param>
        ...
        /// A <see cref="Task"/> that represents the wrapped execution of the inner action.
        /// </returns>
        static public void RunWithErrorHandling(Action action, TaskRunOptions options = null)
        {
            // Validate
            if (action == null) throw new ArgumentNullException("action");
